...
//   const [latt, setLat] = useState(lat);
//   const [lonn, setLon] = useState(lon);
...
//   return (
//     <div className="flex flex-col md:flex-row h-screen bg-[#fff7ed] text-[#1e293b]">
//       {/* Left Panel */}
...
//         />
//         <h2 className="text-3xl font-bold text-[#1e293b]">{hotel.name}</h2>
...
//             className="bg-[#ffad72] text-[#1e293b] font-semibold px-4 py-2 rounded-lg shadow hover:bg-[#ea580c] transition duration-200"
//           >
//             Show Nearest Cafes
//           </button>
//           <button
//             onClick={() => handleFetchPlaces("public-transport")}
//             className="bg-[#ffad72] text-[#1e293b] font-semibold px-4 py-2 rounded-lg shadow hover:bg-[#fb923c] transition duration-200"
//           >
...
//             Ask something about this hotel
//           </label>
//           <input
//             type="text"
//             value={question}
...
//           {loading ? (
//             <div className="text-center mt-3 text-[#f97316] animate-pulse font-medium">
//               Thinking...
//             </div>
//           ) : (
//             answer && (
...
//       {/* Right: Map */}
//       <div className="md:w-1/2 h-[500px] md:h-full rounded-lg overflow-hidden shadow-lg">
//         <MapContainer
//           center={[latt, lonn]}
//           zoom={14}
...
//                 <strong className="text-lg">{hotel.name}</strong>
//                 <br />
//                 {hotel.address}
//               </div>
//             </Popup>
...
//   return (
//     <div className="flex flex-col md:flex-row h-screen bg-[#fff7ed] text-[#1e293b] font-sans">
//       {/* Left Panel */}
//       <div className="md:w-1/2 p-6 space-y-6 overflow-y-auto">
//         <img
//           src={hotel.imageUrl}
...
//       <div className="md:w-1/2 h-[500px] md:h-full rounded-lg overflow-hidden shadow-lg">
//         {mapLoading && (
//           <div className="h-full w-full bg-[#f1f5f9] animate-pulse flex items-center justify-center text-[#94a3b8]">
//             <div className="text-center">
