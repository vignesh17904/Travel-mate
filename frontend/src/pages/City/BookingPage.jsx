 ...
 const handleBooking = async () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10 bg-white shadow-md rounded-lg mt-6">
      ...
      <img src={hotel.imageUrl} alt={hotel.name} className="w-full h-64 object-cover rounded-xl mb-6" />
      <p className="text-gray-700 mb-2">{hotel.description}</p>
      <p className="text-gray-600 mb-4">Address: {hotel.address}</p>
      <p className="text-lg font-semibold text-green-600">₹{hotel.pricePerNight} / night</p>
      ...
      <button
        ...
        disabled={loading}
        className="mt-6 bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold shadow-md"
      >
